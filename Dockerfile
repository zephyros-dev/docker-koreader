FROM docker.io/curlimages/curl:8.18.0@sha256:5e058e1f726dd941b1db83ed6fad363e00d3aed1186cf9517b245fe111911921 AS curl
ARG ARCH='uname -m'
...
FROM ghcr.io/linuxserver/baseimage-selkies:fedora42@sha256:adb84dac977e23c3b915c5b6aa8b28f885f5d1813b29605839ea74ed6f1bf1a5 AS fedora
ENV \
    HARDEN_DESKTOP=True \
    HARDEN_OPENBOX=True \
    NO_GAMEPAD=True \
...
FROM ghcr.io/linuxserver/baseimage-selkies:debiantrixie@sha256:bd6bcacd4175810452bc6e46cc369b87ceae26aa35dd9843894a361c404bcf45 AS debian
ENV \
    HARDEN_DESKTOP=True \
    HARDEN_OPENBOX=True \
    NO_GAMEPAD=True \
