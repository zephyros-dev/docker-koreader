FROM docker.io/curlimages/curl:8.10.0@sha256:a3838a5cf24fe940ec63e98fc37ce1dbe1d43286dc2b803c5bc5e9f067c7ad6d AS curl
ARG ARCH='uname -m'
...
FROM ghcr.io/linuxserver/baseimage-kasmvnc:debianbookworm@sha256:18763432f5432384229682ab6d15f5c3842f0109bbad2d100ee02a57a4b62ecd AS base
ENV \
    TITLE="Koreader" \
    START_DOCKER=false
