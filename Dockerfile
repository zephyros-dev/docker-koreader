FROM docker.io/curlimages/curl:8.22.0@sha256:58adaa4e8dca9c988bae2aba4ab3434a0bb2da16bbe3f92dec39ec7785166777 AS curl
ARG ARCH='uname -m'
...
FROM ghcr.io/linuxserver/baseimage-selkies:debiantrixie@sha256:82df55995a7fdda0aed32a2a2ccb59202003f57cb92b36d78a7fb078e202f2c3
ENV \
    HARDEN_DESKTOP=True \
    HARDEN_OPENBOX=True \
    NO_GAMEPAD=True \
