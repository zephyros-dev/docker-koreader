FROM ghcr.io/linuxserver/baseimage-kasmvnc:debianbookworm@sha256:597a12ace4f00bcf776d179eb6a04ea8d8f2837fefd1bfc7486c32058f029e58
ARG ARCH='dpkg --print-architecture'
ARG KOREADER_VERSION=v2024.01
